...
# The charts help us visualise what is happening to the irr for both cases.
# Effectively, we can see that the insurance acts as a protection, hence "cutting"
# the tails of the distribution, pushing more instances of simulations around the mean.
